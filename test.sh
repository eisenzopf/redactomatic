python3 redactomatic.py --regextest --no-redact --testoutputfile regextest.csv

python3 redactomatic.py --chunksize 20 --column 4 --idcolumn 1 --modality voice --inputfile ./data/sample_data_voice.csv --outputfile voice_output_l2.csv --log voice_log_l2.csv --level 2 
...
python3 redactomatic.py --column 4 --idcolumn 1 --modality text --inputfile ./data/anonymized_sample_data.csv --outputfile text_output_anonymized_only.csv --anonymize --no-redact --level 3 --seed 2
python3 redactomatic.py --column 4 --idcolumn 1 --modality voice --inputfile ./data/anonymized_sample_data.csv --outputfile voice_output_anonymized_only.csv --anonymize --no-redact --level 3 --seed 2

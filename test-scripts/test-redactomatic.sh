...
python3 $BINDIR/redactomatic.py --column 4 --idcolumn 1 --modality voice --rulefile $CUSTOMRULES --chunksize 20 --inputfile $INPUTDIR/sample_data_voice.csv --outputfile $voice_redacted_l2 --log $voice_log_l2 --level 2 
python3 $BINDIR/redactomatic.py --column 4 --idcolumn 1 --modality text  --rulefile $CUSTOMRULES --inputfile $INPUTDIR/sample_data.csv --outputfile $text_redacted_l2 --log $text_log_l2 --level 2
python3 $BINDIR/redactomatic.py --column 4 --idcolumn 1 --modality voice --rulefile $CUSTOMRULES --inputfile $INPUTDIR/sample_data_voice.csv --outputfile $voice_redact_anonymized_l2 --anonymize --seed 1 --level 2
python3 $BINDIR/redactomatic.py --column 4 --idcolumn 1 --modality text  --rulefile $CUSTOMRULES --inputfile $INPUTDIR/sample_data.csv --outputfile $text_redact_anonymized_l2 --anonymize --seed 1 --level 2

#Test redaction at level 3
python3 $BINDIR/redactomatic.py --column 4 --idcolumn 1 --modality voice --rulefile $CUSTOMRULES --inputfile $INPUTDIR/sample_data_voice.csv --outputfile $voice_redacted_l3 --log $voice_log_l3 --level 3
python3 $BINDIR/redactomatic.py --column 4 --idcolumn 1 --modality text  --rulefile $CUSTOMRULES --inputfile $INPUTDIR/sample_data.csv --outputfile $text_redacted_l3 --log $text_log_l3 --level 3
